      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        {step === 1 && (
          <div className="space-y-8 mt-4">
            ...
            {/* Disclaimer for Tanques service */}
            {service.name.toLowerCase().includes('tanques') && (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-amber-800 dark:text-amber-200">
                      El precio final del servicio puede variar dependiendo de qué tan accesible sea el lugar donde se realizará el trabajo. Nuestro equipo evaluará las condiciones del sitio antes de confirmar el costo definitivo.
                    </p>
                  </div>
                </div>
              </div>
